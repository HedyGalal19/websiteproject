...
<head>
	...
	<link rel="stylesheet" href="../../app/js/jquery.treeview.css" />
	<link rel="stylesheet" href="../../app/js/screen.css" />
	<style>
        .tag { color: blue; }
        .attr { color: #990033; }
    </style>
	<script src="../../app/js/jquery.js" type="text/javascript"></script>
	<script src="../../app/js/jquery.treeview.js" type="text/javascript"></script>
    ...
    <br>
	<div id="sidetreecontrol"><a href="../../app/?#">Collapse All</a> | <a href="../../app/?#">Expand All</a></div><br>
