...
function mail_html_content($title,$minihead,$subject,$content){
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
    ...
    </div>    <div style="background-color:#539FD8;">
      <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;" class="block-grid two-up ">
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:#539FD8;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:transparent;"><![endif]-->

              <!--[if (mso)|(IE)]><td align="center" width="300" style=" width:300px; padding-right: 0px; padding-left: 0px; padding-top:10px; padding-bottom:15px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><![endif]-->
            <div class="col num6" style="max-width: 320px;min-width: 300px;display: table-cell;vertical-align: top;">
              <div style="background-color: transparent; width: 100% !important;">
              <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:10px; padding-bottom:15px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->

                  
                    <div align="center" class="img-container center  autowidth  " style="padding-right: 0px;  padding-left: 0px;">
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px;line-height:0px;"><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
  <img class="center  autowidth " align="center" border="0" src="../img/logo.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 272px" width="272">
<div style="line-height:5px;font-size:1px">&#160;</div><!--[if mso]></td></tr></table><![endif]-->
              ...
              <!--[if (mso)|(IE)]></td><td align="center" width="300" style=" width:300px; padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:15px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><![endif]-->
            <div class="col num6" style="max-width: 320px;min-width: 300px;display: table-cell;vertical-align: top;">
              <div style="background-color: transparent; width: 100% !important;">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
	...
	<div style="line-height:120%;color:#555555;font-family:"Montserrat", "Trebuchet MS", "Lucida Grande", "Lucida Sans Unicode", "Lucida Sans", Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 5px; padding-bottom: 10px;">	
		<div style="font-size:12px;line-height:14px;font-family:Montserrat, "Trebuchet MS", "Lucida Grande", "Lucida Sans Unicode", "Lucida Sans", Tahoma, sans-serif;color:#555555;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><strong><span style="font-size: 20px; line-height: 24px;">'.$minihead.'</span></strong></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
	...
	<div style="line-height:180%;color:#555555;font-family:"Lato", Tahoma, Verdana, Segoe, sans-serif; padding-right: 25px; padding-left: 25px; padding-top: 5px; padding-bottom: 20px;">	
		<div style="font-size:12px;line-height:22px;color:#555555;font-family:"Lato", Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 25px;text-align: center"><span style="line-height: 28px; font-size: 16px;">'.$content.'</span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
	...
	<div style="line-height:120%;color:#555555;font-family:"Lato", Tahoma, Verdana, Segoe, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
		<div style="font-size:12px;line-height:14px;color:#555555;font-family:"Lato", Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><strong>&copy; 2017 Car Park Valeting.</strong> All rights reserved</p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
function emailthis($to, $subject,$content,$from,$bcc,$attach = ''){
	//Create a new PHPMailer instance

	$mail = new PHPMailer;
	if(empty($from)){
		$from = 'eastbournecw@eastbournecw.xyz';
		$fromname = 'cpv';
		$mail->isSMTP();
		$mail->SMTPDebug = 0; 
		$mail->Debugoutput = 'html'; 
		$mail->Host = "mx1.hostinger.co.uk";	
		$mail->Port = 587;	
		$mail->SMTPAuth = true;	
		//Username to use for SMTP authentication
		$mail->Username = "eastbournecw@eastbournecw.xyz";	
		//Password to use for SMTP authentication
		$mail->Password = "Hedy316118";
	}else{
		$fromname = '';
	}
	...
	foreach ($addr2 as $ad2) {
		$mail->AddBCC( trim($ad2) );       
	}
...
////SEND ACCESSIBILITY EMAIL 
//function send_email_to_all($subject,$mailcontent){
//	require 'connections.php';
//	$query="select Email, Fname from Users WHERE 1";//select query for viewing users.  
//    $run=mysqli_query($con,$query);//here run the sql query.  
//	
//    while($row=mysqli_fetch_array($run)){
//		$mcontent = '<p>Dear '.$row['Fname'].', '.$mailcontent.'</p>';
//		$content = mail_html_content($subject,$mcontent);
//		emailthis($row['Email'], $subject, $content,'','','');
//	}	
//}

//function send_email_to($subject,$mailcontent,$id){
//	require 'connections.php';
//	$id = (int)$id;
//	$query="select Email from Users WHERE userID = $id";//select query for viewing users.  
//    $run=mysqli_query($con,$query);//here run the sql query.  
//	$array = array();
//    while($row=mysqli_fetch_array($run)){
//		$array[] = $row['Email'];
...
//	$to = implode(',',$array); 
//
//	$content = mail_html_content($subject,$mailcontent);
//	emailthis($to, $subject, $content,'','','');
//}

function send_email_to1($subject,$mailcontent,$email){
	$content = mail_html_content($subject,$mailcontent);
	emailthis($email, $subject, $content,'','','');
}
function send_email_rebooking($firstname,$carreg,$carmodel,$caryear,$carsize,$service,$extraoption,$date,$time,$totalprice,$to){
	$title = 'Updated Booking Details';
	$minihead = 'Booking details have been updated - Please Check the details below';
	$subject = 'Car Wash Booking Confirmation';
	$mcontent = '<center><p>Hello '.$firstname.'</p>
				<table style="width: 100%;" border="3" cellpadding="5">
					<tbody>
					<tr>
					<td>Car Details</td>
					<td>'.$carreg.', '.$caryear.', '.$carmodel.'</td>
					</tr>
					<tr>
					<td>Car Size</td>
					<td>'.$carsize.'</td>
				...
				<p>If any one the details are incorrect, Please contact us before the booking date</p></center>';
	$content = mail_html_content($title,$minihead,$subject,$mcontent);
	emailthis($to, $subject, $content,'','','');
}

function send_email_booking($firstname,$carreg,$carmodel,$caryear,$carsize,$service,$extraoption,$date,$time,$totalprice,$to){
	$title = 'Booking';
	$minihead = 'Thank you for Booking - Please Check the details below';
	$subject = 'Car Wash Booking Confirmation';
	$mcontent = '<center><p>Hello '.$firstname.'</p>
				<table style="width: 100%;" border="3" cellpadding="5">
					<tbody>
...
function send_email_register($firstname,$to,$code){
	$title = 'Registration';
	$minihead = 'Account Activation';
	$subject = 'Please activate your Car Park Valeting account';
	$mcontent = '<center><p>Hello '.$firstname.'</p>
				<p>Thanks for signing up! You are just one step away from completing your registration and becoming part of the Car Park Valeting Community.</p>
	            <a href="http://eastbournecw.xyz/functions/confirm.php?passkey='.$code.'"
			  style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Activate Account!</a></center>';
	$content = mail_html_content($title,$minihead,$subject,$mcontent);
	emailthis($to, $subject, $content,'','','');
}

function send_email_forgotpassword($firstname,$to,$code){
	$title = 'Password Reset';
	$minihead = 'Password Reset Request';
	$subject = 'Reset Password';
	$mcontent = '<center><p>Hello '.$firstname.'</p>
				<p>We received a request to reset your password for your Car Park Valeting Account. we are here to help!</p>
				<p>Simply click on the button to set a new password:</p>
	            <a href="http://eastbournecw.xyz/passwordreset.php?passkey='.$code.'"
			  ...
			  <p>If you did not mean to reset your password, then you can just ignore this email: your password will not change. </p></center>';
	
	$content = mail_html_content($title,$minihead,$subject,$mcontent);
	emailthis($to, $subject, $content,'','','');
}

function send_email_passwordreset($firstname,$to){
	$title = 'Password Reset';
	$minihead = 'Password Reset Request';
	$subject = 'Reset Password';
	$mcontent = '<center><p>Hello '.$firstname.'</p>
				<p>We received a request to reset your password for your Car Park Valeting Account. we are here to help!</p>
				<p>Your new Password is the last 4 digits of your first name and the last 4 digits of your phone number. You can change your password once you have logged in</p>
			  <p>If you did not mean to reset your password, then you can just ignore this email: your password will not change. </p></center>';
