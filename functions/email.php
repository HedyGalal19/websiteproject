...
function send_email_contact($name,$subjectm,$message,$email,$to){
	$title = 'Customer Contact Us';
		$minihead = 'Contact Details Below';
...
function send_email_register($firstname,$to,$code){
	...
	$mcontent = '<center><p>Hello '.$firstname.'</p>
	            ...
	            <a href="http://www.eastbournecw.xyz/functions/confirm.php?passkey='.$code.'"
...
function send_email_forgotpassword($firstname,$to,$code){
	...
	$mcontent = '<center><p>Hello '.$firstname.'</p>
	            ...
	            <a href="http://www.eastbournecw.xyz/passwordreset.php?passkey='.$code.'"
